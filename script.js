      ...
      if (window.zappyContactFormLoaded) {
        (async function() {
          try {
            ...
            const zappyPayload = {
              websiteId: 'bfe4be93-2599-4e53-8286-e86578b63d28',
              ...
              subject: formDataObject.subject || formDataObject.topic || 'Contact Form Submission',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דן-גור ביטוחים בע״מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
